                                           ...
                                           <?php foreach($projects as $value): ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <a href="pDelet?D=<?php echo base64_encode($value->id); ?>" title="Delete" onclick="confirm('Are you sure you want to Delete This Project!!!')" class="btn btn-sm btn-info waves-effect waves-light projectdelet"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
